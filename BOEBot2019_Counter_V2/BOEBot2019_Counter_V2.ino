...
void Fsm_Run ()
{
  ...
  switch (fsm_state) {
    ...
    case FSM_STATE_TURN_AROUND:
      Drive_Set_Speed(0,0);
      Nav_Set_Target2(NAV_TURN, 50, 180, -1, 0);
    ...
    case FSM_STATE_MOVE_EAST:
      Nav_Set_Target2(NAV_COORD, 50, drive_pos_x + 3, drive_pos_y, -1);
      fsm_state = FSM_STATE_WAIT_NAV;
      fsm_next_state = FSM_STATE_TURN_SOUTH;
      break;

    case FSM_STATE_TURN_SOUTH:
      Nav_Set_Target2(NAV_HEAD, 50, 270, 0, 0);
      fsm_state = FSM_STATE_WAIT_NAV;
    ...
    case FSM_STATE_SCAN_THIRD:
      Turret_Set_Angle(-90);
      Nav_Set_Target2(NAV_COORD, 50, drive_pos_x, drive_pos_y - 2, -1);
      fsm_state = FSM_STATE_WAIT_NAV;
    ...
    case FSM_STATE_MOVE_LEFT:
      Turret_Set_Angle(85);
      Nav_Set_Target2(NAV_COORD, 50, -16, -46, -1);
      fsm_state = FSM_STATE_WAIT_NAV;
    ...
    case FSM_STATE_DECIDE:
      ...
      if (total == 1) {
        Turret_Set_Angle(-45);
        Nav_Set_Target2(NAV_COORD, -50, -14, -46, 1);
        fsm_state = FSM_STATE_WAIT_NAV;
        fsm_next_state = FSM_STATE_DONE;
      }
      if (total == 2) {
        Turret_Set_Angle(0);
        Nav_Set_Target2(NAV_COORD, -50, -6, -46, -1);
        fsm_state = FSM_STATE_WAIT_NAV;
        fsm_next_state = FSM_STATE_DONE;
      }
      if (total == 3) {
        Turret_Set_Angle(45);
        Nav_Set_Target2(NAV_COORD, -50, 2, -46, -1);
        fsm_state = FSM_STATE_WAIT_NAV;
        fsm_next_state = FSM_STATE_DONE;
      }
      if (total == 4) {
        Turret_Set_Angle(90);
        Nav_Set_Target2(NAV_COORD, -50, 10, -46, -1);
        fsm_state = FSM_STATE_WAIT_NAV;
        fsm_next_state = FSM_STATE_DONE;
      }
      if (total == 0) {
        Turret_Set_Angle(-90);
        Nav_Set_Target2(NAV_COORD, 50, -22, -46, -1);
        fsm_state = FSM_STATE_WAIT_NAV;
        fsm_next_state = FSM_STATE_DONE;
      }
